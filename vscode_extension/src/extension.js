...
class SnowstormEditorProvider {
    ...
    webviewPanel.webview.onDidReceiveMessage(async (e) => {
      switch (e.type) {
        ...
        case "request_texture":
          ...
          let filePath = vscode.Uri.joinPath(vscode.Uri.parse(path_arr.join("/")), e.path.replace(/\.png$/, "") + ".png");
  ...
  getHtmlForWebview(webview) {
    const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this.context.extensionUri, "snowstorm", "app.js"));
